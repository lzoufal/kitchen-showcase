...
export async function FeaturedKitchens({ kitchens }: FeaturedKitchensProps) {
  const t = await getTranslations('home.featuredKitchens')
                ...
                <div className="relative aspect-[16/10] overflow-hidden">
                  ...
                  {kitchen.isNew && (
                    <div className="absolute top-4 left-4">
                      <Badge variant="gold">{tCommon('new')}</Badge>
                    </div>
                  )}
                </div>
